...
cd $1;
curl -LsS https://repo1.maven.org/maven2/io/gatling/highcharts/gatling-charts-highcharts-bundle/3.9.2/gatling-charts-highcharts-bundle-3.9.2-bundle.zip > gatling.zip
unzip gatling.zip
...
[[ \$# -ne 4 ]] && echo "Usage: \$0 <urlbase> <benchmark description> <simulation> <duration (minutes)>" && exit 1
export JAVA_OPTS="-DbaseUrl=\$1 -Dincrement=128 -Dsteps=32 -Dduration=\$4"
