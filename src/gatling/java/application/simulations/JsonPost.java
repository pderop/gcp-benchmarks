...
public class JsonPost extends Simulation {
...

	{
		...
		ScenarioBuilder scenarioBuilder =
				scenario("Post JSON and receive JSON payload")
						.forever().on(exec(http("jsonPost").post("/user").header("Content-Type", "application/json").body(StringBody(body))));
